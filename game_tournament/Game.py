...
def a_tournament():
    ...
    players_mex = ['Chicharito','Piojo','Guardado','Hector Moreno','Rafa Marquez','Salcido','Vela','Dos Santos','Herrera','Layun','Corona']
    players_arg = ['Messi','Di Maria','Aguero','Higuain','Mascherano','Biglia','Dybala','Paredes','Tagliafico','Otamendi','Zabaleta']
    players_peru= [ 'Guerrero','Carrillo','Cueva','Flores','Yotun','Tapia','Advincula','Trauco','Araujo','Garcia','Gallese']
    players_france= ['Griezmann','Mbappe','Pogba','Kante','Varane','Lloris','Matuidi','Giroud','Umtiti','Pavard','Hernandez']  
    players_spain=[ 'Ramos','Iniesta','Busquets','Isco','Asensio','Pique','Alba','Koke','Saul','Rodrigo','De Gea']
    players_brazil=[ 'Neymar','Firmino','Coutinho','Casemiro','Alisson','Marcelo','Thiago Silva','Paulinho','Willian','Fernandinho','Danilo']
    players_italia= ['Buffon','Chiellini','Bonucci','Donnarumma','Insigne','Bernardeschi','Verratti','De Rossi','Marchisio','Balotelli','Immobile'] 
    players_japan=[ 'Kagawa','Honda','Okazaki','Nagatomo','Hasebe','Yoshida','Kawashima','Inui','Shibasaki','Muto','Sakai']
    sport = Sport("Futbol", 11, "FIFA")
    team_mex = Team("Mexico", sport)
    team_arg = Team("Argentina", sport)
    team_peru = Team("Peru", sport)
    team_france = Team("Ffrance", sport)
