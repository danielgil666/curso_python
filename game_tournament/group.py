    ...
    def display_standings(self):
        ...
        for team, stats in dsort:
            ...
            def get_qualified_teams(self):
                """ Get the qualified teams from the group. """
                sorted_teams = sorted(self.points.items(), key=lambda x: x[1]['points'], reverse=True)
                qualified_teams = [team for team, stats in sorted_teams[:2]]  # Get top 2 teams
